...
function getPointForNonTextNode(editorRoot, startNode, childOffset) {
  ...
  if (editorRoot === node) {
    ...
    !(win && node instanceof win.Element && node.getAttribute('data-contents') === 'true') ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Invalid DraftEditorContents structure.') : invariant(false) : void 0;
    if (childOffset > 0) {
